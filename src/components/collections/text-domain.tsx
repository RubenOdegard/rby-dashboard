...
const TextDomain = ({
	...
	return (
		<Link href={domain || ""} target="_blank" className="flex items-center justify-start gap-2">
			<h3
				className={`text-pretty truncate border-foreground text-xl font-bold decoration-yellow-400 underline-offset-4 transition-all hover:underline sm:text-2xl ${
